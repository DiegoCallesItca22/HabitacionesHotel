    ...
    <div class="flex min-h-screen">
        <aside class="hidden w-2/5 border-r-2 border-hotel-mid bg-hotel-dark lg:flex lg:flex-col lg:justify-between">
            <div class="p-10 animate-hotel-fade">
                <div class="mb-8 flex h-14 w-14 items-center justify-center border-2 border-hotel-light bg-hotel-mid text-xl font-bold text-white">
                    ZZ
                </div>
                <h2 class="text-3xl font-bold leading-tight text-white">Hotel Zizu</h2>
