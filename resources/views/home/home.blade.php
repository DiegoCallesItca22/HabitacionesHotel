...
<div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
    @php
        $cards = [
            ['label' => 'Usuarios', 'value' => $stats['usuarios'], 'delay' => 'stagger-1', 'badge' => 'hotel-badge-blue'],
            ['label' => 'Habitaciones', 'value' => $stats['habitaciones'], 'delay' => 'stagger-2', 'badge' => 'hotel-badge-green'],
            ['label' => 'Reservas', 'value' => $stats['reservas'], 'delay' => 'stagger-3', 'badge' => 'hotel-badge-amber'],
            ['label' => 'Facturas', 'value' => $stats['facturas'], 'delay' => 'stagger-4', 'badge' => 'hotel-badge-gray'],
            ['label' => 'Pagos completados', 'value' => '$' . number_format((float) $stats['pagos'], 2), 'delay' => 'stagger-5', 'badge' => 'hotel-badge-green', 'wide' => true],
        ];
    @endphp
