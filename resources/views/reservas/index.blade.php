                ...
                <tr>
                    ...
                    <td>
                        <div class="flex justify-end gap-2">
                            <a href="{{ route('reservas.edit', $reserva->id) }}" class="hotel-btn-secondary">
                            ...
                            @if(in_array($reserva->estado, ['pendiente', 'confirmada']))
                                <form action="{{ route('reservas.cancelar', $reserva->id) }}" method="POST" class="inline">
                                    @csrf
                                    <button type="submit" class="hotel-btn-secondary text-red-700 border-red-200 hover:bg-red-50">
                                        <i data-lucide="x"></i>
                                        Cancelar
                                    </button>
                                </form>
